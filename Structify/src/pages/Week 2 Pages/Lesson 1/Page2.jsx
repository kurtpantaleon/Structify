...
import Bullet2 from '../../../assets/image/Lesson1.2/image5.png'; // Image source for lesson 2
import Bullet3 from '../../../assets/image/Lesson1.2/image6.png'; // Image source for lesson 3
     ...
     },
    {
      description: (
        <>
          ...
          (steps: cross laces → loop → tighten).
          </span>{' '}
