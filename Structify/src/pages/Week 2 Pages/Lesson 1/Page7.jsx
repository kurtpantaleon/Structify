...
import Bullet1 from '../../../assets/image/Lesson1.2/image19.png'; // Image source for lesson 1
import Bullet2 from '../../../assets/image/Lesson1.2/image20.png'; // Image source for lesson 2
...
export default function Page1() {
  ...
  const lessons = [
     ...
     },
    {
      description: (
        <>
          Searching for a contact in a {' '}
          <span className="font-extrabold text-yellow-400 animate-pulse">
          phonebook is like Binary Search.
          </span>{' '}
