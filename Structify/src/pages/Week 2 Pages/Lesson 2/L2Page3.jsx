...
import Bullet1 from '../../../assets/image/Lesson2.2/image6.png';
import Bullet2 from '../../../assets/image/Lesson2.2/image7.png'; // Image source for lesson 2
    ...
    },
    {
      description: (
        <>
          Example: {' '}
          <span className="font-extrabold text-green-400 animate-pulse">
          Sorting 1,000 vs. 1,000,000 numbers.
          </span>{' '}
