...
import Bullet1 from '../../../assets/image/Lesson3.2/image7.png'; // Image source for lesson 1
import Bullet2 from '../../../assets/image/Lesson3.2/image8.png'; // Image source for lesson 2
import Bullet3 from '../../../assets/image/Lesson3.2/image9.png'; // Image source for lesson 3
        ...
        <LessonPages
          title={
            <span className="text-3xl font-black text-center text-teal-400 drop-shadow-md">
             Step-by-Step Example: Sorting [6, 0, 3, 5]
            </span>
          }
          lessons={lessons}
