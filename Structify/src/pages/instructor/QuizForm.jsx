        ...
        <div className="flex flex-wrap gap-4">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="text-xl font-semibold text-gray-800">{quizContent.questions.length}</p>
            </div>
          </div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="text-xl font-semibold text-gray-800">{quizContent.timeLimit} min</p>
            </div>
          </div>
...
const calculateDifficulty = (questions) => {
  if (questions.length === 0) return "Not enough questions";
