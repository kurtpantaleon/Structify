...
import Bullet1 from '../../../assets/image/Lesson3.1/image19.png';
import Bullet2 from '../../../assets/image/Lesson3.1/image20.png';
import Bullet3 from '../../../assets/image/Lesson3.1/image21.png';
  ...
  const lessons = [
    {
         description: (
           <>
            ...
            Arrays: 
             </span>{' '}  Store names sequentially for lookup.
         ...
         description: (
           <>
             <span className="font-extrabold text-green-400 animate-pulse">
              Hashing:
             </span>{' '} Maps names to memory for faster access.
           </>
         ),
         mediaType: 'image',
         image: Bullet2,  
    ...
    <div className="flex-grow flex flex-col justify-center items-center gap-8 overflow-y-auto px-4 animate-fade-in">
      <LessonPages
        title={
          ...
          Searching for contacts in a phone directory
          </span>
        }
        lessons={lessons}
