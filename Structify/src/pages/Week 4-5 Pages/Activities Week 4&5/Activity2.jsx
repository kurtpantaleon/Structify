...
const options = ["Array", "Record", "Pointer"];

const questions = [
  "An ______ holds multiple elements of the same type. ",
  "A ______ stores a group of related data with different types. ",
  "A ______ points to a memory location. ",
];

const correctAnswers = {
  "An ______ holds multiple elements of the same type. ": "Array",
  "A ______ stores a group of related data with different types. ": "Record",
  "A ______ points to a memory location. ": "Pointer",
};
...
export default function Activity2() {
  ...
  const goToNextActivity = () => {
    window.location.href = "/week4activity3";
  };
  
  const goToPreviousActivity = () => {
    window.location.href = "/week4activity1";
  };
