...
const questions = [
  "An ________ holds multiple elements of the same type. ",
  "A ________ stores a group of related data with different types. ",
  "A ________ points to a memory location. ",
];

const correctAnswers = {
  "An ________ holds multiple elements of the same type. ": "Array",
  "A ________ stores a group of related data with different types. ": "Record",
  "A ________ points to a memory location. ": "Pointer",
};
