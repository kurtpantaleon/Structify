...
import Bullet1 from '../../../assets/image/Lesson4.3/image6.png'; // Image source for lesson 1
import Bullet2 from '../../../assets/image/Lesson4.3/image7.png';
      ...
      <div className="flex-grow flex flex-col justify-center items-center gap-8 overflow-y-auto px-4 animate-fade-in">
        <LessonPages
          title={
            ...
            How Pointers Help in Memory Management
            </span>
          }
          lessons={lessons}
