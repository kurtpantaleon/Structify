...
import Bullet1 from '../../../assets/image/Lesson4.3/image10.png'; // Image source for lesson 1
  ...
  const lessons = [
    {
      description: (
        <>
          ...
          and  {' '}
          <span className="font-extrabold text-yellow-400 animate-pulse">
          help manage memory dynamically.
          </span>{' '}
    ...
    <div className="h-screen overflow-hidden bg-gradient-to-b from-[#1F274D] to-[#0E1328] text-white flex flex-col font-sans relative">
      ...
      {currentIndex === lessons.length - 1 && (
        <LessonFooter
          buttonText="Continue"
          onClick={() => {
            markLessonComplete('Week4lesson3');
            navigate('/week4Activity1');
          }}
