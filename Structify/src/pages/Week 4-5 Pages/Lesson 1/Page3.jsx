...
import Bullet1 from '../../../assets/image/Lesson4.1/image5.png'; // Image source for lesson 1
import Bullet2 from '../../../assets/image/Lesson4.1/image6.png';
...
export default function Page1() {
  ...
  const lessons = [
    ...
    },
    {
      description: (
        <>
       Instead of creating separate variables, you can store  {' '}
          <span className="font-extrabold text-green-400 animate-pulse">
          all related values in one structure.
          </span>
        </>
      ),
      mediaType: 'image',
