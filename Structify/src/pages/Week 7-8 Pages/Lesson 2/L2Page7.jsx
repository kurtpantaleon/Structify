...
import Bullet1 from '../../../assets/image/Lesson7.2/image14.png';
import Bullet2 from '../../../assets/image/Lesson7.2/image15.png';
  ...
  const lessons = [
    {
      description: (
        <>
          ...
          When a queue is full and no more elements can be added.
    ...
    },
    {
      description: (
        <>
          ...
          When a queue is empty and no elements can be dequeued.
