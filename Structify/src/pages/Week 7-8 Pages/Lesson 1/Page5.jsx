...
import Bullet1 from '../../../assets/image/Lesson7.1/image9.png';
import Bullet2 from '../../../assets/image/Lesson7.1/image10.png';
...
export default function Page1() {
  ...
  const lessons = [
    ...
    },
    {
      description: (
        <>
         When the function completes, the {' '}
      ...
      <div className="flex-grow flex flex-col justify-center items-center gap-8 overflow-y-auto px-4 animate-fade-in">
        <LessonPages
          title={
           ...
           Stack in Function Calls (Call Stack)
            </span>
          }
          lessons={lessons}
