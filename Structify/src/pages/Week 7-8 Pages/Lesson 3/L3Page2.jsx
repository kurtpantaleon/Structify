...
import Bullet1 from '../../../assets/images/Week7&8-3 Images/Lesson3/Page 2/Bullet 1.png';
...
export default function L3Page2() {
  ...
  const lessons = [
    {
      description: <>Russian nesting dolls—each doll contains a smaller version of itself.</>,
      image: Bullet1
    }
  ];
