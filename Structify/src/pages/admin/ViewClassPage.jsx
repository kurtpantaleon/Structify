...
import { Users, ChevronLeft, UserCheck, GraduationCap, Search, BarChart, Edit3, Trash2, X, Save, AlertTriangle, CheckCircle, CheckSquare, Square, Mail } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="flex mt-0">
        ...
        {/* Class Details */}
        <div className="flex-1 max-w-7xl mx-auto mt-10 mb-8">
