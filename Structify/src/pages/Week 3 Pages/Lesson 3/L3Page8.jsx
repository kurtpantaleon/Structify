...
import Bullet1 from '../../../assets/image/Lesson3.3/image10.png'; // Image source for lesson 1
    ...
    <div className="h-screen overflow-hidden bg-gradient-to-b from-[#1F274D] to-[#0E1328] text-white flex flex-col font-sans relative">
      ...
      {currentIndex === lessons.length - 1 && (
        <LessonFooter
          buttonText="Continue"
          onClick={() => {
            markLessonComplete('Week3lesson3');
            navigate('/week3Activity1')
          }}
