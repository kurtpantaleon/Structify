...
const questions = [
  "The ________function converts text to uppercase.",
  " ________ breaks a string into smaller parts.",
  "To replace 'hello' with 'hi', use  ________",
  "The function to remove spaces at the beginning and end is  ________",
  "To count the length of a string, use  ________"
];

const correctAnswers = {
  "The  ________ function converts text to uppercase.": "toUpperCase()",
  " ________ breaks a string into smaller parts.": "split()",
  "To replace 'hello' with 'hi', use  ________.": "replace()",
  "The function to remove spaces at the beginning and end is  ________.": "trim()",
  "To count the length of a string, use  ________.": "length"
};
