...
export default function Activity1() {
  ...
  useEffect(() => {
    if (activityScores && activityScores["Week3activity1"] !== undefined) {
      setScore(activityScores["Week3activity1"]);
      setFeedback(`Your previous score: ${activityScores["Week3activity1"]}/100`);
    }
  }, [activityScores]);
  ...
  const handleSubmit = async () => {
    ...
    await markActivityComplete("Week3activity1", calculatedScore); // Save the score in the context

    setTimeout(() => {
      navigate("/week3activity2");
    }, 3000);
  };
    ...
    <>
      ...
      <div className="bg-[#1c2452] min-h-screen flex flex-col overflow-hidden relative z-10">
        ...
        <div className="flex justify-between items-center p-4 border-b border-blue-500/40 backdrop-blur-md bg-white/10">
          <button onClick={() => (window.location.href = "/week3Page")} className="text-white hover:text-red-400 transition-colors">          
