...
import Bullet1 from '../../../assets/image/Additional3.1/image7.png'; // Image source for lesson 1
import Bullet2 from '../../../assets/image/Additional3.1/image8.png'; // Image source for lesson 2
  ...
  const lessons = [
    {
      description: (
        <>
         Strings allow computers to  {' '}
          <span className="font-extrabold text-yellow-400 animate-pulse">
          display messages, store usernames, and process text data.
          </span>
