...
import Bullet1 from '../../../assets/image/Additional3.1/image18.png'; // Image source for lesson 1
  ...
  const lessons = [
    {
      description: (
       ...
       Strings are a {' '}
        ...
        fundamental part of data storage
          </span>{' '}
          and widely used in programming, databases, and file systems.
        </>
      ),
      mediaType: 'image',
      image: Bullet1,      
