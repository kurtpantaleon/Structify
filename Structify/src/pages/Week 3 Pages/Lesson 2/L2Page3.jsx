...
import Bullet1 from '../../../assets/image/Additional3.2/image5.png'; // Image source for lesson 1
import Bullet2 from '../../../assets/image/Additional3.2/image6.png'; // Image source for lesson 2
  ...
  const lessons = [
    {
      description: (
        <>
          Extract a portion of a string using {' '}
