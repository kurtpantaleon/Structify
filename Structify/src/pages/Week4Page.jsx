          ...
          <div className=" flex items-start gap-8 ">
            ...
            <div className="w-6/12 flex-shrink-0">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <CardSection title="Understanding Arrays – The Basics" subtitle="Lesson 1" progress={12.5} path="/week4Page1"  mediaSrc={card1} mediaType="video"/>
                <CardSection title=" Understanding Records – Grouping Data" subtitle="Lesson 2" progress={0} path="/week4L2Page1" mediaSrc={card2} mediaType="video"/>
                <CardSection title=" Pointers – How Computers Track Data" subtitle="Lesson 3" progress={0} path="/week4L3Page1" mediaSrc={card3} mediaType="video" />
                <CardSection title=" Build a Simple Contact List" subtitle="Challenge" progress={0} path="/quizWeek4" mediaSrc={Challenges} mediaType="video"/>
              </div>
            </div>
