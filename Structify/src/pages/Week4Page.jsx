          ...
          <div className="flex items-start gap-8">
            ...
            <div className="w-5/10 flex-shrink-0"> 
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <CardSection title="Introduction to Data Structures" subtitle="Lesson 1" progress="1/8" path="/week4page1" />
                <CardSection title="Computers and Data Structures" subtitle="Lesson 2" progress="0/8" path="/week4L2Page1" />
                <CardSection title="Types of Data Structures?" subtitle="Lesson 3" progress="0/8" path="/week4L3Page1" />
