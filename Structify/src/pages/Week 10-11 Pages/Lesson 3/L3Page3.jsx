...
import Bullet1 from '../../../assets/image/Lesson10.3/image5.png';
  ...
  const lessons = [
    {
      description: (
        <>
          ...
          Visiting rooms in a building systematically
          </span>{' '}
          to ensure no room is left unchecked.
  ...
  return (
    <div className="h-screen overflow-hidden bg-gradient-to-b from-[#1F274D] to-[#0E1328] text-white flex flex-col font-sans relative">
      ...
      <div className="flex-grow flex flex-col justify-center items-center gap-8 overflow-y-auto px-4 animate-fade-in">
        <LessonPages
          title={
           ...
           Real-Life Example of Tree Traversal
            </span>
          }
          lessons={lessons}
      ...
      {currentIndex === lessons.length - 1 && (
        <LessonFooter
          buttonText="Continue"
          onClick={() => navigate('/week10L3Page4')}
