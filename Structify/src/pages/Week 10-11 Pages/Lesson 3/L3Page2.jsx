...
import Bullet1 from '../../../assets/image/Lesson10.3/image2.png';
import Bullet2 from '../../../assets/image/Lesson10.3/image3.png';
import Bullet3 from '../../../assets/image/Lesson10.3/image4.png';
  ...
  return (
    <div className="h-screen overflow-hidden bg-gradient-to-b from-[#1F274D] to-[#0E1328] text-white flex flex-col font-sans relative">
      ...
      {currentIndex === lessons.length - 1 && (
        <LessonFooter
          buttonText="Continue"
          onClick={() => navigate('/week10L3Page3')}
