...
import Bullet1 from '../../../assets/images/Week10&11-3 Images/Lesson3/Page 1/Bullet 1.png';
...
export default function L3Page1() {
  ...
  const lessons = [
    {
      description: <>Traversal means visiting all nodes in a tree in a specific order.</>,
      image: Bullet1
    }
  ];
