...
import Bullet1 from '../../../assets/image/Lesson10.2/image7.png';
import Bullet2 from '../../../assets/image/Lesson10.2/image8.png';;
    ...
    },
    {
      description: (
        <>
          ...
          (e.g., AVL, Red-Black trees) solve this issue.
  ...
  return (
    <div className="h-screen overflow-hidden bg-gradient-to-b from-[#1F274D] to-[#0E1328] text-white flex flex-col font-sans relative">
      ...
      {currentIndex === lessons.length - 1 && (
        <LessonFooter
          buttonText="Continue"
          onClick={() => navigate('/week10L2Page8')}
