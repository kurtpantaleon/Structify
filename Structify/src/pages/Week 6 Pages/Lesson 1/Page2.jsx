...
import Bullet1 from '../../../assets/image/Lesson6.1/image3.png';
import Bullet2 from '../../../assets/image/Lesson6.1/image4.png';
  ...
  const lessons = [
    {
      description: (
        <>
          ...
          where each clue leads to the next location.
        </>
      ),
    mediaType: 'image',
            image: Bullet1,
    },
    {
      description: (
       ...
       A {' '}
          ...
          where each coach is linked to the next.
