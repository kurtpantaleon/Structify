...
import Bullet1 from '../../../assets/image/Lesson6.2/image8.png';
  ...
  const lessons = [
    {
      description: (
        <>
          ...
          where each person knows {' '}
          <span className="font-extrabold text-yellow-400 animate-pulse">
          only the next person.
          </span>
        </>
      ),
        mediaType: 'image',
