...
const options = ["Node ", "Tail ", "Head ",];
const descriptions = [
"An element storing data and a reference.",
"The first node in a linked list.",
"Contacts List on Phone"
];

const correctAnswers = {
  "An element storing data and a reference.": "Node",
  "The first node in a linked list.": "Tail",
  "Contacts List on Phone": "Head",
...
export default function Activity1() {
  ...
  const goToNextActivity = () => {
    window.location.href = "/week6activity2";
  };
