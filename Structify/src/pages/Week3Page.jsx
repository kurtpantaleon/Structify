          ...
          <div className="flex items-start gap-8">
            ...
            <div className="w-5/10 flex-shrink-0"> 
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <CardSection title="Introduction to Data Structures" subtitle="Lesson 1" progress="1/8" path="/week3Page1" />
                <CardSection title="Computers and Data Structures" subtitle="Lesson 2" progress="0/8" path="/week3L2Page1"/>
                <CardSection title="Types of Data Structures?" subtitle="Lesson 3" progress="0/8"path="/week3L3Page1" />
            ...
            <div className="w-5/10 flex-shrink-0"> 
              ...
              <div className="space-y-4">
                <WeekButton title="Lesson 1" status="LEARN" icon={CheckIcon} iconType={StudyIcon} path="/week3Page1"  />
                <WeekButton title="Lesson 2" status="LEARN" icon={UncheckIcon} iconType={StudyIcon} path="/week3L2Page1"/>
                <WeekButton title="Lesson 3" status="LEARN" icon={UncheckIcon} iconType={StudyIcon} path="/week3L3Page1" />
              </div>

              {/* Activities */}
              <div className="mt-4 space-y-4">
                <WeekButton title="Activity 1" status="PRACTICE" icon={UncheckIcon} iconType={PracticeIcon} path="/week3Activity1"/>
                <WeekButton title="Activity 2" status="PRACTICE" icon={UncheckIcon} iconType={PracticeIcon} path="/week3Activity2"/>
                <WeekButton title="Activity 3" status="PRACTICE" icon={UncheckIcon} iconType={PracticeIcon} path="/week3Activity3"/>
              </div>
            </div>
